    ...
    <div class="x_panel">
      ...
      <div class="x_content">
	      <form 
	      	...
	      	id="form" action="<?php echo base_url("parameter/modify/".$parameter["ID"]); ?>" novalidate>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input 
                type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $parameter["NAME"]?>"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input 
                type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $parameter["VALUE"]?>"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea class="form-control resizable_textarea" name="description"><?php echo $parameter["DESCRIPTION"]?></textarea>
            </div>
          </div>
